...
function HomeCatalog (props) {
    ...
    const interesting_questions = [
...

        {
            id: 2,
            question: 'Доставка? ',
            answer1: 'Доставка осуществляется бесплатно при заказе на сумму от 3 000 руб., при заказе до 3 000 руб. стоимость доставки составить 300 руб.',
