...
function HomeCatalog (props) {
    ...
    const interesting_questions = [
...

        {
            id: 2,
            question: 'Доставка? ',
            answer1: 'Доставка осуществляется бесплатно при заказе на сумму от 3 000 руб. При заказе на сумму менее 3 000 руб. стоимость доставки составит 300 руб.',
            answer2:  'Вся продукция изготавливается под заказ, а мясные наборы доставляются без заморозки в течение суток после разруба и упаковки (мясо не замораживается). Мы принимаем предзаказы от покупателей, готовим продукцию и назначаем дату доставки. В одном направлении мы возим товары 1—2 раза в неделю. За день до доставки мы согласуем время прибытия курьера. На месте курьер поднимет ваш заказ на любой этаж и занесет, если потребуется.\n',
            answer3:  'Таким образом, вы получаете продукцию практически в день изготовления с запасом срока годности.',
            answer4:  'Товары перевозятся в специально оборудованных автомобилях в нужных температурных диапазонах. Все продукты разложены по коробкам с учетом товарного соседства и веса.',
        },
        {
            id: 3,
    ...
    const makePhoneCall = () => {
        ...
        if (Platform.OS === 'android') {
            phoneNumber = 'tel:${+7 (999) 112-23-33}';
        } else {
            phoneNumber = 'telprompt:${+7 (999) 112-23-33}';
        }
                ...
                <View style={styles.interesting_question_popup_wrapper}>
                    ...
                    <ScrollView style={{flex: 1, width: '100%'}}>
                        ...
                        <Text style={styles.interesting_question_popup_text}>
                            Доставка осуществляется бесплатно при заказе на сумму от 3 000 руб. При заказе на сумму менее 3 000 руб. стоимость доставки составит 300 руб.                        </Text>
                        <Text style={styles.interesting_question_popup_text}>
                            Вся продукция изготавливается под заказ, а мясные наборы доставляются без заморозки в течение суток после разруба и упаковки (мясо не замораживается). Мы принимаем предзаказы от покупателей, готовим продукцию и назначаем дату доставки. В одном направлении мы возим товары 1—2 раза в неделю. За день до доставки мы согласуем время прибытия курьера. На месте курьер поднимет ваш заказ на любой этаж и занесет, если потребуется.                        </Text>
                        <Text style={styles.interesting_question_popup_text}>
